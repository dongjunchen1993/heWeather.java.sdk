...
public interface HeWeatherLocationService {
    ...
    HeWeatherResponse getLocation(String location, String key, String sign);
    ...
    HeWeatherResponse getLocation(String location, String key, String adm, String range, String sign);

    //热门城市搜索（key = 用户认证ID;）
    HeWeatherResponse getTopLocation(String key, String sign);
    ...
    HeWeatherResponse getTopLocation(String key, String adm, String range, String lang, String sign);

    //poi信息搜索 (location = 城市名称，key = 用户认证ID ；  type = poi类型 ;）
    HeWeatherResponse getLookupPoiLocation(String location, String key, String type, String sign);
    ...
    HeWeatherResponse getRangePoiLocation(String location, String key, String type, String sign);
